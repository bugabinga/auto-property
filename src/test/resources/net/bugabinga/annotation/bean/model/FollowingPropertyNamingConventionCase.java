 ...
 */
@AutoProperty
public abstract class FollowingPropertyNamingConventionCase {
  public abstract Property<Integer> stateProperty();

  public abstract Property<String> nameProperty();
  FollowingPropertyNamingConventionCase() {
    // hidden c'tor
  }
}
