...
/**
 * Only abstract classes should be annotated with {@link AutoProperty}. This interface is expected
 * to throw an error if processed by {@link Processor}.
 *
 * @author Oliver Jan Krylow (okrylow@gmail.com)
 *
 */
@AutoProperty
public class AnnotatedInterfaceCase {
}
