...
/**
 * Classes annotated with {@link AutoProperty} should be abstract. This class is expected to throw
 * an error if processed by {@link Processor}.
 *
 * @author Oliver Jan Krylow (okrylow@gmail.com)
 *
 */
@AutoProperty
public class NonAbstractClassAnnotatedCase {
}
