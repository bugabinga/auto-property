...
public class Processor extends AbstractProcessor {
  ...
  private final Element warnIfInterface(final Element element) {
  ...
  private final Element warnIfNotAbstract(final Element element) {
